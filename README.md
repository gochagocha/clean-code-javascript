...
რა თქმა უნდა სახელმძღვანელოში წარმოდგენილ ყველა პრინციპს მკაცრად ვერ დაიცავთ, თუმცა გახოვდეთ, რომ ეს გაიდლაინები შემუშავებულია _Clean Code_-ის ავტორთა მრავალწლიანი კოლექტიური გამოცდილების გათვალისწინებით.

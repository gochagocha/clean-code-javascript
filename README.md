...
```javascript
// გლობალურ კონსტანტად გამოცხადება, სახელის ყველა ასო არის მთავრული.
...
const menuConfig = {
  title: "Order",
  // მომხმარებელმა არ დაამატა 'body' ველი
  buttonText: "Send",
  cancellable: true
};
